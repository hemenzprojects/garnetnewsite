...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "http://laravel.test/api/v1"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Ghanaian Academic and Research Network - Connecting Ghana's education sector"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"GARNET - Ghanaian Academic and Research Network"};
